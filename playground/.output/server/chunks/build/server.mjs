import { version, unref, inject, defineComponent, ref, provide, createElementBlock, useSSRContext, createApp, effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, computed, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const global_45queue_45it = /* @__PURE__ */ defineNuxtRouteMiddleware(() => {
  return;
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DiRDnX8m.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DKPa4xXJ.mjs').then((r) => r.default || r));
